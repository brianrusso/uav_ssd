...
from datasets import uav_to_tfrecords, pascalvoc_to_tfrecords
...
def main(_):
    ...
    elif FLAGS.dataset_name == 'uav':
        uav_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    else:
